MOB QUEST playable core v87
- サブクエスト2追加：海底 / 草原Ⅱ / 部族村 / 田舎町Ⅱ / ネオン街Ⅱ / マグマⅡ / 砂漠Ⅱ
- サブクエストは従来通り QUEST1→2→3→4→5 の順番制。未解放・クリア済みは非表示
- 海底必須：モブネコクー / モブピンク / モブデザート
- 草原Ⅱ必須：モブテツ / モブデンデン / モブニョロ
- 部族村必須：モブジェシー / モブマニー / モブピンク
- 田舎町Ⅱ必須：モブデンデン / モブデザート / モブネコクー
- 特殊戦：ウェイブ本気、パワージョーンズ、ハネスライム、ホーク2体、タフネス3回行動、二人の長2回行動、暴走2体、ジュラシック残存強化、ウミデンデンⅡ、マグバスター、ドラゴン連戦等を反映
- 砂漠ⅡQUEST5「ミラモブの系譜」は敵編成未設定のため設定待ちのまま
- 田舎町QUEST3「海賊が来た！」は報酬番号未設定のため設定待ちのまま
