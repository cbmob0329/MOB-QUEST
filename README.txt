MOB QUEST v69 RECREATED - 2026-08-27

再生成版
- 冒険画面の不要な「勇・桃・砂」等の略字表示を除去
- 探索/キャンプの木目を横方向へ統一し、砂漠の探索結果を高コントラスト化
- モブリリス表示サイズを拡大
- 施設会話の改行・余白・文字サイズを再調整
- コーチ退出台詞を「また来てくれよな！ / レッツトレーニング！」へ変更
- 敵通常攻撃の前進モーションを強化
- 戦闘開始演出を1秒完了してからターン開始
- 戦闘中の敵会話表示時間を延長
- 砂漠II Area3中ボス復活時の会話演出を補強
- キャンプはテント/椅子/ドリンクをAREAごとに個別1回
- 戦闘中の入れ替え編成を戦闘後も維持
- 必殺技CTを戦闘間で保存
- 戦闘外ステータス確認ポップアップを追加
- お城メニューを2+3配置にし鍛冶屋を追加
- 最新フィギュア一覧/モンスター&ボス/51タグを反映
