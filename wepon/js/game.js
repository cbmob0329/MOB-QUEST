...
function defaultMeta(){return{coins:0,diamonds:0,exp:{},inventory:{},drinkSets:{},weapons:{},medals:{},armors:{},equipment:{},figures:{},figureEquipment:{},figureOrder:[],defeatedBosses:[],defeatedElites:[],subquests:{cleared:{}},openingComplete:false,trainingPlayed:false,heroPassive2Unlocked:false,moneyFriendsUnlocked:false};}
...
function createTitleV88(){let t=$('#titleScreenV88');if(t)return t;t=document.createElement('section');t.id='titleScreenV88';t.className='title-screen-v88';t.innerHTML='<img class="title-bg-v88" src="back/title.png" data-fallback-src="back/rpgmain.png" alt=""><div class="title-shade-v88"></div><div class="title-ui-v88"><img src="icon/01.png" class="title-logo-v88" alt="MOB QUEST"><strong class="title-logo-fallback-v89">MOB QUEST</strong><b class="title-ver-v88">v89</b><button data-title-new-v88 type="button">NEW GAME</button><button data-title-continue-v88 type="button">CONTINUE</button><button data-title-settings-v88 type="button">設定</button></div>';($('#app')||document.body).appendChild(t);bindImages(t);t.querySelector('[data-title-new-v88]').onclick=startNewGameV88;t.querySelector('[data-title-continue-v88]').onclick=continueGameV88;t.querySelector('[data-title-settings-v88]').onclick=()=>{t.hidden=true;openSettings();};return t;}
