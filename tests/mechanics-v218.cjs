...
const injection=`window.mechanics218=async()=>{
 ...
 await soulFeedbackBaseV220(f,a,[a],[e],'味方全体のATKを12.5%アップし、SPDを10%アップする。敵全体のDEFを20%ダウンさせる',true);
 ...
 await soulFeedbackBaseV220(f,a,[a],[{...e,uid:'test'}],'敵単体に火属性と水属性の2連続物理中ダメージを与える');
