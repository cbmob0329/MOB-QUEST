...
function defaultMeta(){return{coins:0,diamonds:0,exp:{},inventory:{},drinkSets:{},weapons:{},medals:{},equipment:{},figures:{},figureEquipment:{},figureOrder:[],ultimateCooldowns:{},openingCompleted:false,starterGrantReceived:false,firstGrassReviveUsed:false,firstGrassReviveCount:0,defeatedBosses:[],defeatedElites:[]};}
...
async function performMagic(a,skill=null,auto=false){
  ...
  try{
    if(chosen.target==='all'){await skillSprite(chosen.frames,'enemy-all',chosen.mode);await playerAoeDamage(a,chosen.power,'magic',0);}
