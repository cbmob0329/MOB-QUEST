...
async function setTrainingMode(mode){
  ...
  if(['journal','exp','gold','boss'].includes(mode)){
    ...
    const pop=$('#trainingFeaturePopup');if(pop)pop.hidden=false;
  ...
  }else $('#trainingFeaturePopup').hidden=true;
}
