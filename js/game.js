...
function createTitleV88(){let t=$('#titleScreenV88');if(t)return t;t=document.createElement('section');t.id='titleScreenV88';t.className='title-screen-v88';t.innerHTML='<img class="title-bg-v88" src="back/title.png" onerror="this.src=\'back/rpgmain.png\'"><div class="title-shade-v88"></div><div class="title-ui-v88"><img src="icon/01.png" class="title-logo-v88"><b class="title-ver-v88">v88</b><button data-title-new-v88>NEW GAME</button><button data-title-continue-v88>CONTINUE</button><button data-title-settings-v88>設定</button></div>';document.body.appendChild(t);t.querySelector('[data-title-new-v88]').onclick=startNewGameV88;t.querySelector('[data-title-continue-v88]').onclick=continueGameV88;t.querySelector('[data-title-settings-v88]').onclick=()=>{t.hidden=true;openSettings();};return t;}
