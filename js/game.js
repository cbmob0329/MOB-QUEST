...
function ensureMobPieceOverlayV96(){let ov=$('#mobPieceOverlayV96');if(ov)return ov;ov=document.createElement('div');ov.id='mobPieceOverlayV96';ov.className='mob-piece-overlay-v96';ov.hidden=true;document.body.appendChild(ov);return ov;}
