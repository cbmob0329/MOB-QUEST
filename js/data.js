...
const MOB_DATA = {
  ...
  bosses: [
    ...
    {id:'ace',name:'モブエース',stage:'ネオン街',attribute:'闇',image:'boss/08.png',symbol:'紫',kind:'single',power:1.65,bg:'back/neon4.png',fallbackBg:'back/neon.png'},
    ...
    {id:'umiDenden',name:'モブウミデンデン',stage:'田舎町Ⅱ',attribute:'雷',image:'boss/16.png',symbol:'海',special:'マシンガングミ',kind:'multi',power:.88,hits:[3,6],bg:'back/inaka4.png',fallbackBg:'back/inaka.png'},
...
// ===== MOB QUEST v58 : latest ボス(8) authoritative update =====
{
  ...
  const grass2=worldById('grassland2');if(grass2)grass2.areas[3].boss=[{id:'g2-tsuru',level:56},{id:'boss-hawk2',level:60},{id:'g2-savanna',level:56}];
...
(()=>{
  ...
  up('dc2-kirin',{name:'覚醒モブキリンリリス',stage:'魔王城Ⅱ',category:'elite',attribute:'雷',image:'boss/45.png',symbol:'雷',levelMin:85,levelMax:85,special:'サンダーボルト',kind:'aoeParalyzeChance',power:1.30,chance:.10,skillElement:'雷',skillType:'magic',actionCount:2,actionCountRange:[1,2]});
  ...
  up('dc2-kufu',{name:'覚醒モブクフリリス',stage:'魔王城Ⅱ',category:'elite',attribute:'光',image:'boss/47.png',symbol:'光',levelMin:85,levelMax:85,special:'ライトニング・エナジーキューブ',kind:'aoeSleepChance',power:1.30,chance:.10,skillElement:'光',skillType:'magic',actionCount:2,actionCountRange:[1,2]});
  up('dc2-lilith',{name:'モブリリス',stage:'魔王城Ⅱ',category:'boss',attribute:'闇',image:'boss/21.png',symbol:'薔',levelMin:85,levelMax:85,bossId:'lilith2',special:'ブラックホール',kind:'v88HealAoeUltLock',power:1.35,heal:.06,skillElement:'闇',skillType:'magic',actionCount:3,actionCountRange:[2,3],specialEvery:3,damageReduction:.10,permanentDamageReduction:true,critDamageReduction:.10,specialOptions:[
  ...
  up('dc2-enma',{name:'モブ閻魔',stage:'魔王城Ⅱ',category:'boss',attribute:'火',image:'boss/30.png',symbol:'閻',levelMin:90,levelMax:90,bossId:'enma',special:'ジャッジメントソード',kind:'aoeStunChance',power:1.90,chance:.30,skillElement:'火',skillType:'physical',actionCount:3,actionCountRange:[1,3],specialEvery:3,damageReduction:.10,permanentDamageReduction:true,critDamageReduction:.10,specialOptions:[{special:'ジャッジメントソード',kind:'aoeStunChance',power:1.90,chance:.30,skillElement:'火',skillType:'physical'},{special:'ジャッジメントフレイム',kind:'burnSingle',power:2.55,chance:.70,skillElement:'火',skillType:'magic'}]});
  up('dc2-enma2',{name:'モブ閻魔 第二形態',stage:'魔王城Ⅱ',category:'boss',attribute:'火',image:'boss/31.png',symbol:'閻',levelMin:92,levelMax:92,bossId:'enma2',special:'ジャッジメントソード',kind:'aoeStunChance',power:1.95,chance:.30,skillElement:'火',skillType:'physical',actionCount:3,actionCountRange:[1,3],specialEvery:3,damageReduction:.10,permanentDamageReduction:true,critDamageReduction:.10,specialOptions:[{special:'ジャッジメントソード',kind:'aoeStunChance',power:1.95,chance:.30,skillElement:'火',skillType:'physical'},{special:'ジャッジメントフレイム',kind:'burnSingle',power:2.60,chance:.70,skillElement:'火',skillType:'magic'}]});
  up('dc2-enma3',{name:'モブ閻魔 最終形態',stage:'魔王城Ⅱ',category:'boss',attribute:'火',image:'boss/32.png',symbol:'閻',levelMin:94,levelMax:94,bossId:'enmaFinal',special:'ジャッジメントソード',kind:'aoeStunChance',power:2.00,chance:.30,skillElement:'火',skillType:'physical',actionCount:3,actionCountRange:[2,3],specialEvery:3,damageReduction:.10,permanentDamageReduction:true,critDamageReduction:.10,specialOptions:[{special:'ジャッジメントソード',kind:'aoeStunChance',power:2.00,chance:.30,skillElement:'火',skillType:'physical'},{special:'ジャッジメントフレイム',kind:'burnSingle',power:2.65,chance:.70,skillElement:'火',skillType:'magic'}]});
  up('dc2-maou',{name:'モブ魔王',stage:'魔王城Ⅱ',category:'boss',attribute:'闇',image:'boss/22.png',symbol:'王',levelMin:95,levelMax:95,bossId:'maou2',special:'キング・ダーク・カノン',kind:'single',power:2.65,skillElement:'闇',skillType:'magic',actionCount:3,actionCountRange:[2,3],specialEvery:3,damageReduction:.10,permanentDamageReduction:true,critDamageReduction:.10,specialOptions:[
  ...
  up('dc2-ulrilis',{name:'ウルモブリリス',stage:'魔王城Ⅱ',category:'boss',attribute:'闇',image:'boss/36.png',symbol:'闇',levelMin:99,levelMax:99,bossId:'ulLilith',special:'ブラックホール',kind:'v88HealAoeUltLock',power:1.48,heal:.06,skillElement:'闇',skillType:'magic',actionCount:3,actionCountRange:[2,3],specialEvery:3,pyramidEvery:5,damageReduction:.10,permanentDamageReduction:true,critDamageReduction:.10,specialOptions:[
...
// ===== MOB QUEST v141 : TRIBE VILLAGE AUTHORITATIVE BATTLE UPDATE =====
{
  ...
  const ryugo=byId('t-ryugo');if(ryugo){ryugo.v141KingsRage=true;}
