...
const TEMP_BALANCE = {
  ...
  magicNote:'技の習得者は未設定。威力・MP・依存ステータスはv66テストバランス。'
};

const MOB_DATA = {
  elements: {
    '火': { label:'火', spell:'ホノマ', skillId:'magic-fire-2', cost:10, power:1.28, frames:['skill/05.png','skill/06.png','skill/07.png','skill/08.png','skill/04.png'] },
    '水': { label:'水', spell:'ネプマ', skillId:'magic-water-2', cost:10, power:1.28, frames:['skill/17.png','skill/18.png','skill/19.png','skill/17.png'] },
    '雷': { label:'雷', spell:'トルマ', skillId:'magic-thunder-2', cost:10, power:1.28, frames:['skill/29.png','skill/30.png','skill/31.png'] },
    '地': { label:'地', spell:'ゴレマ', skillId:'magic-earth-2', cost:10, power:1.28, frames:['skill/39.png','skill/40.png','skill/41.png','skill/42.png'] },
    '風': { label:'風', spell:'ホクマ', skillId:'magic-wind-2', cost:10, power:1.28, frames:['skill/49.png','skill/50.png','skill/51.png','skill/52.png'] },
    '光': { label:'光', spell:'ネオマ', skillId:'magic-light-2', cost:10, power:1.28, frames:['skill/54.png','skill/55.png','skill/57.png','skill/58.png','skill/56.png'] },
    '闇': { label:'闇', spell:'ミラマ', skillId:'magic-dark-2', cost:10, power:1.28, frames:['skill/65.png','skill/66.png','skill/67.png','skill/68.png'] },
    '無': { label:'無', spell:'アノマ', skillId:'magic-neutral-1', cost:7, power:1.05, frames:['skill/127.png','skill/128.png','skill/129.png','skill/130.png'] }
  },

  battleSkills: [{"id":"magic-fire-1","name":"ホノ","category":"magic","element":"火","cost":5,"power":0.86,"frames":["skill/01.png","skill/02.png","skill/03.png","skill/04.png"],"desc":"敵単体に火属性の小魔法ダメージ。MAG依存。","tier":1},{"id":"magic-fire-2","name":"ホノマ","category":"magic","element":"火","cost":10,"power":1.28,"frames":["skill/05.png","skill/06.png","skill/07.png","skill/08.png","skill/04.png"],"desc":"敵単体に火属性の中魔法ダメージ。MAG依存。","tier":2},{"id":"magic-fire-3","name":"ホノマグマ","category":"magic","element":"火","cost":18,"power":1.78,"frames":["skill/09.png","skill/10.png","skill/11.png","skill/12.png","skill/05.png","skill/06.png"],"desc":"敵単体に火属性の大魔法ダメージ。MAG依存。","tier":3},{"id":"magic-water-1","name":"ネプ","category":"magic","element":"水","cost":5,"power":0.86,"frames":["skill/13.png","skill/14.png","skill/15.png","skill/16.png"],"desc":"敵単体に水属性の小魔法ダメージ。MAG依存。","tier":1},{"id":"magic-water-2","name":"ネプマ","category":"magic","element":"水","cost":10,"power":1.28,"frames":["skill/17.png","skill/18.png","skill/19.png","skill/17.png"],"desc":"敵単体に水属性の中魔法ダメージ。MAG依存。","tier":2},{"id":"magic-water-3","name":"ネプマチューン","category":"magic","element":"水","cost":18,"power":1.78,"frames":["skill/20.png","skill/21.png","skill/22.png","skill/23.png","skill/22.png","skill/21.png"],"desc":"敵単体に水属性の大魔法ダメージ。MAG依存。","tier":3},{"id":"magic-thunder-1","name":"トル","category":"magic","element":"雷","cost":5,"power":0.86,"frames":["skill/24.png","skill/25.png","skill/26.png","skill/27.png"],"desc":"敵単体に雷属性の小魔法ダメージ。MAG依存。","tier":1},{"id":"magic-thunder-2","name":"トルマ","category":"magic","element":"雷","cost":10,"power":1.28,"frames":["skill/29.png","skill/30.png","skill/31.png"],"desc":"敵単体に雷属性の中魔法ダメージ。MAG依存。","tier":2},{"id":"magic-thunder-3","name":"トルマデン","category":"magic","element":"雷","cost":18,"power":1.78,"frames":["skill/32.png","skill/33.png","skill/34.png","skill/30.png","skill/28.png"],"desc":"敵単体に雷属性の大魔法ダメージ。MAG依存。","tier":3},{"id":"magic-earth-1","name":"ゴレ","category":"magic","element":"地","cost":5,"power":0.86,"frames":["skill/35.png","skill/36.png","skill/37.png","skill/38.png"],"desc":"敵単体に地属性の小魔法ダメージ。MAG依存。","tier":1},{"id":"magic-earth-2","name":"ゴレマ","category":"magic","element":"地","cost":10,"power":1.28,"frames":["skill/39.png","skill/40.png","skill/41.png","skill/42.png"],"desc":"敵単体に地属性の中魔法ダメージ。MAG依存。","tier":2},{"id":"magic-earth-3","name":"ゴレマガーディ","category":"magic","element":"地","cost":18,"power":1.78,"frames":["skill/43.png","skill/44.png"],"desc":"敵単体に地属性の大魔法ダメージ。MAG依存。","tier":3,"fx":{"mode":"earthLarge"}},{"id":"magic-wind-1","name":"ホク","category":"magic","element":"風","cost":5,"power":0.86,"frames":["skill/45.png","skill/46.png","skill/47.png","skill/48.png"],"desc":"敵単体に風属性の小魔法ダメージ。MAG依存。","tier":1},{"id":"magic-wind-2","name":"ホクマ","category":"magic","element":"風","cost":10,"power":1.28,"frames":["skill/49.png","skill/50.png","skill/51.png","skill/52.png"],"desc":"敵単体に風属性の中魔法ダメージ。MAG依存。","tier":2},{"id":"magic-wind-3","name":"ホクマウィング","category":"magic","element":"風","cost":18,"power":1.78,"frames":["skill/51.png","skill/53.png","skill/52.png"],"desc":"敵単体に風属性の大魔法ダメージ。MAG依存。","tier":3,"fx":{"mode":"windLarge"}},{"id":"magic-light-1","name":"ネオ","category":"magic","element":"光","cost":5,"power":0.86,"frames":["skill/54.png","skill/55.png","skill/56.png"],"desc":"敵単体に光属性の小魔法ダメージ。MAG依存。","tier":1,"fx":{"mode":"lightSmall"}},{"id":"magic-light-2","name":"ネオマ","category":"magic","element":"光","cost":10,"power":1.28,"frames":["skill/54.png","skill/55.png","skill/57.png","skill/58.png","skill/56.png"],"desc":"敵単体に光属性の中魔法ダメージ。MAG依存。","tier":2},{"id":"magic-light-3","name":"ネオマニプール","category":"magic","element":"光","cost":18,"power":1.78,"frames":["skill/55.png","skill/57.png","skill/58.png","skill/59.png","skill/60.png"],"desc":"敵単体に光属性の大魔法ダメージ。MAG依存。","tier":3,"fx":{"mode":"lightLarge"}},{"id":"magic-dark-1","name":"ミラ","category":"magic","element":"闇","cost":5,"power":0.86,"frames":["skill/61.png","skill/62.png","skill/63.png","skill/64.png"],"desc":"敵単体に闇属性の小魔法ダメージ。MAG依存。","tier":1},{"id":"magic-dark-2","name":"ミラマ","category":"magic","element":"闇","cost":10,"power":1.28,"frames":["skill/65.png","skill/66.png","skill/67.png","skill/68.png"],"desc":"敵単体に闇属性の中魔法ダメージ。MAG依存。","tier":2},{"id":"magic-dark-3","name":"ミラマゾーン","category":"magic","element":"闇","cost":18,"power":1.78,"frames":["skill/69.png","skill/70.png","skill/71.png","skill/72.png"],"desc":"敵単体に闇属性の大魔法ダメージ。MAG依存。","tier":3},{"id":"magic-neutral-1","name":"アノマ","category":"magic","element":"無","cost":7,"power":1.05,"frames":["skill/127.png","skill/128.png","skill/129.png","skill/130.png"],"desc":"敵単体に無属性の中ダメージ。MAG依存。弱点・耐性に左右されにくい。","tier":1},{"id":"magic-neutral-2","name":"アノマウン","category":"magic","element":"無","cost":15,"power":1.62,"frames":["skill/131.png","skill/132.png","skill/133.png","skill/134.png"],"desc":"敵単体に無属性の大ダメージ。MAG依存。弱点・耐性に左右されにくい。","tier":2},{"id":"slash-fire-1","name":"マグソード","category":"physical","element":"火","cost":4,"power":1.08,"frames":["skill/73.png","skill/74.png","skill/75.png","skill/76.png"],"desc":"敵単体に火属性の小物理ダメージ。ATK依存。","tier":1},{"id":"slash-fire-2","name":"マグマソード","category":"physical","element":"火","cost":10,"power":1.52,"frames":["skill/77.png","skill/78.png","skill/79.png","skill/80.png"],"desc":"敵単体に火属性の中～大物理ダメージ。ATK依存。","tier":2},{"id":"slash-water-1","name":"ネプソード","category":"physical","element":"水","cost":4,"power":1.08,"frames":["skill/81.png","skill/82.png","skill/83.png","skill/84.png"],"desc":"敵単体に水属性の小物理ダメージ。ATK依存。","tier":1},{"id":"slash-water-2","name":"ネプマソード","category":"physical","element":"水","cost":10,"power":1.52,"frames":["skill/81.png","skill/82.png","skill/85.png","skill/86.png"],"desc":"敵単体に水属性の中～大物理ダメージ。ATK依存。","tier":2},{"id":"slash-thunder-1","name":"トルソード","category":"physical","element":"雷","cost":4,"power":1.08,"frames":["skill/87.png","skill/88.png","skill/89.png","skill/90.png"],"desc":"敵単体に雷属性の小物理ダメージ。ATK依存。","tier":1},{"id":"slash-thunder-2","name":"トルマソード","category":"physical","element":"雷","cost":10,"power":1.52,"frames":["skill/91.png","skill/92.png","skill/93.png","skill/94.png"],"desc":"敵単体に雷属性の中～大物理ダメージ。ATK依存。","tier":2},{"id":"slash-neutral-1","name":"アノソード","category":"physical","element":"無","cost":4,"power":1.08,"frames":["skill/95.png","skill/96.png","skill/97.png","skill/98.png"],"desc":"敵単体に無属性の小物理ダメージ。ATK依存。","tier":1},{"id":"slash-neutral-2","name":"アノマソード","category":"physical","element":"無","cost":10,"power":1.52,"frames":["skill/99.png","skill/100.png","skill/101.png","skill/102.png"],"desc":"敵単体に無属性の中～大物理ダメージ。ATK依存。","tier":2},{"id":"slash-dark-1","name":"ミラソード","category":"physical","element":"闇","cost":4,"power":1.08,"frames":["skill/103.png","skill/104.png","skill/105.png","skill/106.png"],"desc":"敵単体に闇属性の小物理ダメージ。ATK依存。","tier":1},{"id":"slash-dark-2","name":"ミラマソード","category":"physical","element":"闇","cost":10,"power":1.52,"frames":["skill/108.png","skill/109.png","skill/110.png","skill/111.png"],"desc":"敵単体に闇属性の中～大物理ダメージ。ATK依存。","tier":2},{"id":"slash-light-1","name":"ネオソード","category":"physical","element":"光","cost":4,"power":1.08,"frames":["skill/112.png","skill/113.png","skill/114.png","skill/115.png"],"desc":"敵単体に光属性の小物理ダメージ。ATK依存。","tier":1},{"id":"slash-light-2","name":"ネオマソード","category":"physical","element":"光","cost":10,"power":1.52,"frames":["skill/116.png","skill/117.png","skill/118.png","skill/119.png"],"desc":"敵単体に光属性の中～大物理ダメージ。ATK依存。","tier":2},{"id":"slash-earth-1","name":"ゴレソード","category":"physical","element":"地","cost":4,"power":1.08,"frames":["skill/120.png","skill/121.png","skill/122.png","skill/123.png"],"desc":"敵単体に地属性の小物理ダメージ。ATK依存。","tier":1},{"id":"slash-earth-2","name":"ゴレマソード","category":"physical","element":"地","cost":10,"power":1.52,"frames":["skill/124.png","skill/125.png","skill/126.png","skill/123.png"],"desc":"敵単体に地属性の中～大物理ダメージ。ATK依存。","tier":2},{"id":"status-confuse","name":"ノイズスクラッチ","category":"status","element":"無","cost":13,"power":0,"frames":[],"desc":"敵単体を混乱にする。成功率はMAGと相手MNDで補正。","status":"confuse","chance":0.48,"turns":3},{"id":"status-sleep","name":"チルローファイ","category":"status","element":"無","cost":12,"power":0,"frames":[],"desc":"敵単体を眠りにする。成功率はMAGと相手MNDで補正。","status":"sleep","chance":0.55,"turns":2},{"id":"status-burn","name":"ファストビート","category":"status","element":"火","cost":8,"power":0,"frames":[],"desc":"敵単体をやけどにする。成功率はMAGと相手MNDで補正。","status":"burn","chance":0.75,"turns":3},{"id":"status-poison","name":"リピートイントロ","category":"status","element":"闇","cost":9,"power":0,"frames":[],"desc":"敵単体を毒にする。成功率はMAGと相手MNDで補正。","status":"poison","chance":0.7,"turns":3},{"id":"status-paralyze","name":"ロングスクラッチ","category":"status","element":"雷","cost":16,"power":0,"frames":[],"desc":"敵単体をマヒにする。強力なため成功率は低め。MAGと相手MNDで補正。","status":"paralyze","chance":0.35,"turns":2},{"id":"aoe-earth-1","name":"ガラガラノタビ","category":"aoeMagic","element":"地","cost":20,"power":0.95,"frames":[],"desc":"敵全体に地属性の中魔法ダメージ。MAG依存。"},{"id":"aoe-dark-1","name":"ギリギリノカルマ","category":"aoeMagic","element":"闇","cost":20,"power":0.95,"frames":[],"desc":"敵全体に闇属性の中魔法ダメージ。MAG依存。"},{"id":"aoe-water-1","name":"ケロノイショウ","category":"aoeMagic","element":"水","cost":20,"power":0.95,"frames":[],"desc":"敵全体に水属性の中魔法ダメージ。MAG依存。"},{"id":"aoe-earth-2","name":"キヅイタキツツキ","category":"aoeMagic","element":"地","cost":20,"power":0.95,"frames":[],"desc":"敵全体に地属性の中魔法ダメージ。MAG依存。"},{"id":"aoe-wind-1","name":"カカシトコムギ","category":"aoeMagic","element":"風","cost":20,"power":0.95,"frames":[],"desc":"敵全体に風属性の中魔法ダメージ。MAG依存。"},{"id":"aoe-light-1","name":"カマエノハナシ","category":"aoeMagic","element":"光","cost":20,"power":0.95,"frames":[],"desc":"敵全体に光属性の中魔法ダメージ。MAG依存。"}],
